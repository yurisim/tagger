...
import { TextTagGeneratorService, TagResult, GeneratorOptions } from '../../services/text-tag-generator.service';
...
export class TagGeneratorComponent {
  ...
  generateTags(): void {
    ...
    this.generatedTags = this.tagGeneratorService.generateTags(textToProcess, options);
